...
## Using excel-export-es6 ##
If you want multiple sheets, just pass an array of configs.  only the first stylesXmlFile will be used. The sheet of the name will be set to 'Sheet (index + 1)' or config.name; 
